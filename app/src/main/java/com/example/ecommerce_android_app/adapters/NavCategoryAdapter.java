...
import com.example.ecommerce_android_app.activities.NavCategoryActivity;
import com.example.ecommerce_android_app.models.NavCategoryModel;

import java.util.List;

public class NavCategoryAdapter extends
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (currentPosition != RecyclerView.NO_POSITION) {
                    ...
                    intent.putExtra("type", list.get(currentPosition).getType());
